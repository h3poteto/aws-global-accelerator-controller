...
func (c *OperatorV1alpha1Client) EndpointGroupBindings(namespace string) EndpointGroupBindingInterface {
	return newEndpointGroupBindings(c, namespace)
}
...
func setConfigDefaults(config *rest.Config) error {
	gv := endpointgroupbindingv1alpha1.SchemeGroupVersion
